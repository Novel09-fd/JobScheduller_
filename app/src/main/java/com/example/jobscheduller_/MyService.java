...
import com.example.jobscheduller_.model.JobSchedullerModel;
import com.example.jobscheduller_.service.APIClient;
import com.example.jobscheduller_.service.APIInterfacesRest;
...
public class MyService extends JobService implements
    ...
    private void writeActualLocation(Location location) {
        ...
        getlocation("Novel",location.getLatitude(),location.getLongitude());
   ...
   // ProgressDialog progressDialog;
    public void getlocation(String username,Double latitude,Double longitude){

        apiInterface = APIClient.getClient().create(APIInterfacesRest.class);
//        progressDialog = new ProgressDialog(MyService.this);
//        progressDialog.setTitle("Loading");
//        progressDialog.show();
        Call<JobSchedullerModel> call3 = apiInterface.track_gps(username,latitude,longitude);
        call3.enqueue(new Callback<JobSchedullerModel>() {
            @Override
            public void onResponse(Call<JobSchedullerModel> call, Response<JobSchedullerModel> response) {

                JobSchedullerModel data = response.body();
            ...
            @Override
            public void onFailure(Call<JobSchedullerModel> call, Throwable t) {
